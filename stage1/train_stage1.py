...
Single GPU, small batch size. Run directly (no torchrun needed):
    ...
    python stage1/train_stage1.py -c stage1/config_stage1.yml --device cuda:0
...
from stage1_model import build_lite_model, build_nano_model
import collate_stage1  # register LiteBatchImageCollate via @register()
...
def main():
    ...
    from stage1_model import count_parameters, count_all_parameters
